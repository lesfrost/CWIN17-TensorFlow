...
parser = argparse.ArgumentParser(description='Decide if an image is a picture of a cow')
parser.add_argument('image', type=str, help='The image image file to check')
args = parser.parse_args()

# cow classifier
CLASSIFIER = CowClassifier()
CLASSIFIER.load_model("model_cows.tflearn")
